...
- Listas são mutaveis ou seja podemos altera-las a todo momento, como
    no caso de ordenar os elementos em ordem alfabetica ou crescente 
    quando se trata de numeros.
